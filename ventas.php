			...
			function(res)
			{
				...
				for (var i=0;i<datos.length;i++) 
				{
					...
					if(info["estado"]==1){
					    ...
					    cod_html+="<center><div id='div_loc' class='col s3 m3 l3'><div class='"+clase+"'><br/><label id='lbl_locacion'>Numero de locación: "+info["numero"]+"<br>Locacion: "+info["descripcion"]+"<center></label><div id='btn_div'>  <a href='#!' class='btn tooltipped btn_informacion transparent btn-flat' data-position='top' data-delay='50' data-tooltip='Informacion de Ventas' data-id='"+info["id_locacion"]+"' data-id_tipo_l='"+info["id_tipo_l"]+"' data-id_ticket='"+info["id_ticket"]+"'><span class='material-icons'>info</span></a>  <a href='#!' class='btn btn_pagar transparent btn-flat tooltipped' data-position='top' data-delay='50' data-tooltip='Informacion de Cuentas' data-id='"+info["id_locacion"]+"' data-id_tipo_l='"+info["id_tipo_l"]+"' data-id_ticket='"+info["id_ticket"]+"'><span class='material-icons'>attach_money</span></a>  <a href='#!' class='btn btn_reservar transparent btn-flat tooltipped' data-position='top' data-delay='50' data-tooltip='Reservar Locacion' data-id='"+info["id_locacion"]+"' data-id_tipo_l='"+info["id_tipo_l"]+"'><span class='material-icons'>https</span></a></div></div></center></div></center>";
