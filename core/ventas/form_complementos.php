			...
			<div class="modal-body">
				<form action="#!" method="post" id="form_ventas_c">
					...
					<div class="input-field">
						...
						<input type="text" name="PRE" id="PRE" placeholder="Precio" class="validate" required>
						<br>
					</div>

					<div class="input-field">
						<label for="CAN" id="c">Cantidad</label>
						<input type="text" name="CAN" id="CAN" placeholder="Cantidad" class="validate" required>
						<br>
					</div>	
